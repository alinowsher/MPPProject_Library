...
//			Address address);
	...
	// public void addCheckoutRecordEntry(String memberId, String isbn) throws
	// LibrarySystemException;
	// i changed bellow. (need to be changed because book copies are being saved
	// already from addBook Method hough its creating only one. There should have
	// another BookCopy[] argument in book constructor )
	...
	// i changed here
	// public void addAuthor(List<Author> authors, String fname, String lname,
	// String tel, String bio, String street, String city, String state, String
	// zip);
